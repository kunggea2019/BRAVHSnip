...
public class DItemProvider extends BaseItemProvider<ProviderMultiEntity> {
    ...
    public void convert(@NonNull BaseViewHolder helper, ProviderMultiEntity providerMultiEntity) {
        helper.setText(R.id.tv_title, "DDDDDDD");

        helper.setTextColor(R.id.tv_title, Color.YELLOW);
